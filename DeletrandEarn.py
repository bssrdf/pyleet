...
If you take a number, you might as well take them all. Keep track of what the value is of 
the subset of the input with maximum M when you either take or don't take M.
...
class Solution:
    def deleteAndEarn(self, nums: List[int]) -> int:
        ...
        for i in range(1, N+1):
            takei = skip + sums[i] # once we take i, eventually we'll take all i's
            skipi = max(skip, take)

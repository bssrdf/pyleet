...
if __name__ == "__main__":
    ...
    print(Solution().decodeCiphertext2(encodedText = "iveo    eed   l te   olc", rows = 4))
    print(Solution().decodeCiphertext2(encodedText = "coding", rows = 1))
    print(Solution().decodeCiphertext2(encodedText = "ch   ie   pr", rows = 3))
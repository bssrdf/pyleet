...
if __name__ == "__main__":
    ...
    # print(Solution().survivedRobotsHealths(positions = [3,40], healths = [49,11], directions = "LL"))
    print(Solution().survivedRobotsHealths(positions = [37,35], healths = [16,19], directions = "RL"))

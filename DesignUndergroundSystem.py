...
customer gets in at time t1 at some station, they get out at time t2 with t2 > t1. 
...
class UndergroundSystem(object):
    ...
    def checkIn(self, id, stationName, t):
        ...
        :rtype: None
        """
        #for each id, only need one record for cheking in
        self.getin[id] = (stationName, t)
    ...
    def checkOut(self, id, stationName, t):
        ...
        :rtype: None
        """
        # on exit, record this trip with the following information
        # start and end station
        # total time 
        # trip count gets bumped by 1
        if id in self.getin:
            name, tin = self.getin[id] # the station and time are the most recently updated
            route = name+'_'+stationName
            total = t - tin
            ti, cnt = self.getout.setdefault(route, (0,0))
            self.getout[route] = (ti+total, cnt+1)
    ...
    def getAverageTime(self, startStation, endStation):
        ...
        if route in self.getout:
            ti, cnt = self.getout[route]
            return ti/cnt   
        return 0.0
...
# Your UndergroundSystem object will be instantiated and called as such:
    ...
    undergroundSystem.checkIn(10, "Leyton", 3)
    undergroundSystem.checkOut(10, "Paradise", 8)
    print(undergroundSystem.getAverageTime("Leyton", "Paradise"))  # return 5.00000
    undergroundSystem.checkIn(5, "Leyton", 10)
    undergroundSystem.checkOut(5, "Paradise", 16)
    print(undergroundSystem.getAverageTime("Leyton", "Paradise")) # return 5.50000
    undergroundSystem.checkIn(2, "Leyton", 21)
    undergroundSystem.checkOut(2, "Paradise", 30)
    print(undergroundSystem.getAverageTime("Leyton", "Paradise")) # return 6.66667
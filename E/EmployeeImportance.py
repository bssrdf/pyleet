...
has a data structure like [1, 15, [2]], and employee 2 has [2, 10, [3]], and employee 
3 has [3, 5, []]. Note that although employee 3 is also a subordinate of employee 1, 
    ...
    def getImportance(self, employees, id):
        ...
        while q:
            ...
            while q:
                idx = q.pop()
                res += imps[idx]
                if subs[idx]: q1.extend(subs[idx])
            q = q1
        return res        

if __name__ == "__main__":
    emp = [[1, 5, [2, 3]], [2, 3, []], [3, 3, []]]
    employees = [ Employee(id, imp, subs) for id, imp, subs in emp]

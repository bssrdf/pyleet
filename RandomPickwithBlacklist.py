...
class Solution:
    ...
    def pick(self) -> int:
        ...
        return self.m[k] if k in self.m else k 


if __name__ == "__main__":
    solution = Solution(7, [2, 3, 5])
    print(solution.pick())# // return 0, any integer from [0,1,4,6] should be ok. Note that for every call of pick,
                   # // 0, 1, 4, and 6 must be equally likely to be returned (i.e., with probability 1/4).
    print(solution.pick())# // return 4
    print(solution.pick())# // return 1
    print(solution.pick())# // return 6
    print(solution.pick())# // return 1
    print(solution.pick())# // return 0
    print(solution.pick())# // return 4
    solution = Solution(2, [])
    for i in range(20):
        print(solution.pick())# // return 0 or 1

...
if __name__ == "__main__":
    ...
    print(Solution().eliminateMaximum2(dist = [1,3,4], speed = [1,1,1]))
    print(Solution().eliminateMaximum2(dist = [1,1,2,3], speed = [1,1,1,1]))
    print(Solution().eliminateMaximum2(dist = [3,2,4], speed = [5,3,2]))

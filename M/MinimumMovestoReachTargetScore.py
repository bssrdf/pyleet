...
You can use the increment operation any number of times, however, you can only use 
the double operation at most maxDoubles times.
...
if __name__ == "__main__":
    ...
    print(Solution().minMoves(target = 656101987, maxDoubles = 1))

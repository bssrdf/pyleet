...
You are given an array of positive integers beans, where each integer represents the 
number of magic beans found in a particular magic bag.
...
if __name__ == "__main__":
    ...
    print(Solution().minimumRemoval(beans = [2,10,3,2]))
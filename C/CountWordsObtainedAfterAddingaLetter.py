...
For example, "abcd" can be rearranged to "acbd", "bacd", "cbda", and so on. Note 
that it can also be rearranged to "abcd" itself.
...
from a string in startWords by performing the operations. The strings in 
